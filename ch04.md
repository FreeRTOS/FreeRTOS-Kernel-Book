...
void vATaskFunction( void * pvParameters )
{
     ...
     * must be deleted before reaching the end of it's implementing function.
     * The NULL parameter passed to the vTaskDelete() API function indicates
     * that the task to be deleted is the calling (this) task.
     */
    vTaskDelete( NULL );
}
```
...
![](media/figure_4_1_top_level_task_states.png)
...
periodically by using a crude null loop to create the period delay. Both
