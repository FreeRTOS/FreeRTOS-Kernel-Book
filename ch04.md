...
[Section 4.13, Scheduling Algorithms](#413-scheduling-algorithms), describes an
optional feature called 'time slicing'. Time slicing was used in the examples 
presented so far, and is the behaviour observed in the output they produced.
...
[Section 4.13: Scheduling Algorithms](#413-scheduling-algorithms)
...
in the *Ready* state). [Section 4.9: The Idle Task and the Idle Task Hook](#49-the-idle-task-and-the-idle-task-hook)
...
the expected system behaviour and demonstrates the execution sequence when the
