...
<a name="tbl5" title="Table 5 The FreeRTOSConfig.h settings that configure the kernel to use various scheduling algorithms"></a>
...
***Table 5*** *The FreeRTOSConfig.h settings that configure the kernel to use various scheduling algorithms*
* * *
