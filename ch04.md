...
- `uxPriority`
  ...
  `(configMAX_PRIORITIES – 1)` is the highest priority. [Section 4.5](#46-task-priorities)
...
[Section 4.12, Scheduling Algorithms](#413-scheduling-algorithms), describes an
...
[Section 4.12: Scheduling Algorithms](#413-scheduling-algorithms)
...
in the *Ready* state). [Section 4.8: The Idle Task and the Idle Task Hook](#49-the-idle-task-and-the-idle-task-hook)
