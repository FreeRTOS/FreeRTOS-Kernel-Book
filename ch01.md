...
[https://www.FreeRTOS.org](http://www.FreeRTOS.org)

[https://www.FreeRTOS.org/plus](http://www.FreeRTOS.org/plus)
...
- Note:
This text is being provided for free. **In return we ask that you use
the business contact email link on**
[https://www.FreeRTOS.org/contact](http://www.FreeRTOS.org/contact)
**to provide feedback, comments and corrections**.** Thank you.
...
applications that use microcontrollers or small microprocessors. This
...
development team, expertise in formal verification, and long-term
...
- Improved efficiency
  ...
  Application code that uses an RTOS can be completely event-driven
  because no processing time needs to be wasted by polling for events that
  have not occurred.

  Countering the efficiency saving is the need to process the RTOS tick
...
The zip file available for download from
[https://www.FreeRTOS.org/Documentation/code](http://www.FreeRTOS.org/Documentation/code)
