...
### 12.3.1 The uxTaskGetStackHighWaterMark() API Function
...
```
*Listing 12.1. The uxTaskGetStackHighWaterMark() API function prototype*
* * *
...
```
*Listing 12.2. The uxTaskGetStackHighWaterMark2() API function prototype*
* * *

Using `configSTACK_DEPTH_TYPE` allows the application writer to control the type
used for stack depth.

### 12.3.2 Run Time Stack Checking—Overview
...
1. Provide the implementation of the hook function, using the exact
   function name and prototype shown in Listing 12.3.

* * *
```c
void vApplicationStackOverflowHook( TaskHandle_t *pxTask, signed char *pcTaskName );
```
*Listing 12.3. The stack overflow hook function prototype*
* * *
...
### 12.3.3 Run Time Stack Checking—Method 1
...
### 12.3.4 Run Time Stack Checking—Method 2
...
### 12.3.4 Run Time Stack Checking—Method 3
...
## 12.4 Use of printf() and sprintf()
...
### 12.5.1 Symptom: Adding a simple task to a demo causes the demo to crash
...
### 12.5.2 Symptom: Using an API function within an interrupt causes the application to crash
...
### 12.5.3 Symptom: Sometimes the application crashes within an interrupt service routine
...
default value. See section 7.8, Interrupt Nesting, and section 12.2,
Interrupt Priorities, for more information.


### 12.5.4 Symptom: The scheduler crashes when attempting to start the first task
...
### 12.5.5 Symptom: Interrupts are unexpectedly left disabled, or critical sections do not nest correctly
...
### 12.5.6 Symptom: The application crashes even before the scheduler is started
...
### 12.5.7 Symptom: Calling API functions while the scheduler is suspended, or from inside a critical section, causes the application to crash
...
inside a critical section.
 ...
 ## 12.6 Additional Debugging Steps
