...
FreeRTOS includes two optional run time stack checking mechanisms. These
...
1. Set `configCHECK_FOR_STACK_OVERFLOW` to either 1 or 2 in
...
1. Provide the implementation of the hook function, using the exact
   function name and prototype shown in Listing 13.2.
...
```
* * *
*Listing 13.2. The stack overflow hook function prototype*
...
## 13.4 Inappropriate Use of printf() and sprintf()

Inappropriate use of `printf()` is a common source of error, and,
...
some of the existing demo tasks. See section 3.2, Example Memory
