...
assertion has deemed to have failed. For example, Listing 11.1 tests the
...
```
*Listing 11.1. Using the standard C assert() macro to check pxMyPointer is not NULL*
* * *
...
### 11.2.1 Example configASSERT() definitions

The definition of `configASSERT()` shown in Listing 11.2 is useful when an
...
```
*Listing 11.2. A simple configASSERT() definition useful when executing under the control of a debugger*
* * *

The definition of `configASSERT()` shown in Listing 11.3 is useful when an
...
```
*Listing 11.3. A configASSERT() definition that records the source code line that failed an assertion*
* * *


## 11.3 Tracealyzer for FreeRTOS
...
* * *
![](media/image82.png)   
*Figure 11.1. FreeRTOS+Trace includes more than 20 interconnected views*

![](media/image83.png)   
*Figure 11.2. FreeRTOS+Trace main trace view - one of more than 20 interconnected trace views*

![](media/image84.png)   
*Figure 11.3. FreeRTOS+Trace CPU load view - one of more than 20 interconnected trace views*

![](media/image85.png)   
*Figure 11.4. FreeRTOS+Trace response time view - one of more than 20 interconnected trace views*

![](media/image86.png)   
*Figure 11.5. FreeRTOS+Trace user event plot view - one of more than 20 interconnected trace views*

![](media/image87.png)   
*Figure 11.6. FreeRTOS+Trace kernel object history view - one of more than 20 interconnected trace views*
* * *


## 11.4 Debug Related Hook (Callback) Functions

### 11.4.1 Malloc failed hook
...
### 11.5.1 Task Run-Time Statistics
...
### 11.5.2 The Run-Time Statistics Clock
...
### 11.5.3 Configuring an Application to Collect Run-Time Statistics
...
### 11.5.4 The uxTaskGetSystemState() API Function
...
the array for each task. `TaskStatus_t` is described by Listing 11.5 and
below.
...
```
*Listing 11.4. The uxTaskGetSystemState() API function prototype*
...
- `pxTaskStatusArray`
  ...
  The `TaskStatus_t` structure is shown in Listing 11.5, and the
...
```
*Listing 11.5. The TaskStatus_t structure*
* * *
...
- `uxCurrentPriority`
  ...
  [8.3, Mutexes (and Binary Semaphores)](ch08.md#mutexes-and-binary-semaphores).
...
### 11.5.5 The vTaskListTasks() Helper Function
...
```
*Listing 11.6. The vTaskListTasks() API function prototype*
* * *
...
An example of the output generated by `vTaskListTasks()` is shown in Figure 11.7.
In the output:
...
* * *
![](media/image88.png)   
*Figure 11.7. Example output generated by vTaskListTasks()*
* * *
...
```
*Listing 11.7. The vTaskList() API function prototype*
* * *
...
### 11.5.6 The vTaskGetRunTimeStatistics() Helper Function
...
```
*Listing 11.8. The vTaskGetRunTimeStatistics() API function prototype*
* * *
...
* * *
![](media/image89.png)   
*Figure 11.8. Example output generated by vTaskGetRunTimeStatistics()*
* * *
 ...
 * * *
 ...
 ```
 *Listing 11.9. The vTaskGetRunTimeStats() API function prototype*
 * * *
...
### 11.5.7 Generating and Displaying Run-Time Statistics, a Worked Example
...
```
*Listing 11.10. 16-bit timer overflow interrupt handler used to count timer overflows*
* * *

Listing 11.11 shows the lines added to FreeRTOSConfig.h to enable the
...
```
*Listing 11.11. Macros added to FreeRTOSConfig.h to enable the collection of run-time statistics*
* * *

The task shown in Listing 11.11 prints out the collected run-time statistics every 5 seconds.
...
```
*Listing 11.11. The task that prints out the collected run-time statistics*
* * *
...
### 11.6.1 Available Trace Hook Macros
...
### 11.6.2 Defining Trace Hook Macros
...
### 11.6.3 FreeRTOS Aware Debugger Plug-ins
